...
class Page extends Think {
    ...
    public function show() {
        ...
        $pageStr	 =	 str_replace(
            array('%header%','%nowPage%','%totalRow%','%totalPage%','%upPage%','%first%','%linkPage%','%downPage%','%prePage%','%nextPage%','%end%'),
            array($this->config['header'],$this->nowPage,$this->totalRows,$this->totalPages,$upPage,$theFirst,$linkPage,$downPage,$prePage,$nextPage,$theEnd),$this->config['theme']);
        $pages=$pageStr;
        return $pageStr;
    }
