...
class RecordAction extends BaseAction
{
    ...
    public function index()
    {
        ...
        $dataList = $this->dao->Field('id,stu_number,name,graduate_date,update_time')->Order('id DESC')->Limit($p->firstRow.','.$p->listRows)->findAll();
        $page = $p->show();
        if ($dataList !== false)
        {
    ...
    {
        parent::_checkPermission();
        $certificates=M('Certificate')->select();
    ...
    {
        parent::_checkPermission('Record_insert');
