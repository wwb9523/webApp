...
class RoleAction extends BaseAction
{
    ...
    public function index()
    {
        ...
        $dataList = $this->dao->Where($condition)->Order('id DESC')->findAll();
        if($dataList !== false)
        {
    ...
    {
        parent::_checkPermission();
        $dataList = M('Module')->Where("module_permission!='all'")->findAll();
        $this->assign('dataList', $dataList);
        $this->display();
    }
    ...
    public function modify()
    {
        ...
        $dataList = D('Module')->Where("module_permission!='all'")->findAll();
        $this->assign('dataList', $dataList);
