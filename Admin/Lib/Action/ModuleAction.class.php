...
class ModuleAction extends BaseAction
{
    ...
    public function index()
    {
        ...
        $dataList = $this->dao->Order('id DESC')->findAll();
    ...
    public function doInstall()
    {
        ...
        $installMsg = "安装开始.....................................<br />";
        $modulePath = DATA. $dot .'Module/'.$ucModuleName;
        //检测安装目录是否存在
    ...
    public function doUninstall()
    {
        ...
        //清理表结构
        $modulePath = DATA.$dot.'Module/'.$moduleName;
    ...
    public function modify()
    {
        ...
        $getModule = $this->dao->where("id='{$item}'")->find();
        empty($getModule) && parent::_message('errorUri', '系统中未找到此模块', U('Module/index'));
        $modulePath = DATA.$dot.'Module/'.$getModule['module_name'];
        $installSql = $modulePath.'/install.sql';
        $uninstallSql = $modulePath.'/uninstall.sql';
