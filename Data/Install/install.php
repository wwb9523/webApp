...
define('YCITY', str_replace('\\', '/', dirname(__FILE__)));
	...
	$.ajax({   
		  type:"POST",   
			  ...
			  success:function(data){
				...
				{
					case 'phpFalse':
						$("#setupLoading").html('<span style="color:#FF0000">您的PHP版本低于5, 无法使用 Y-cityCMS</span>');
					break
					case 'tablepreFalse':
					...
					case 'createDatabaseFalse':
						$("#setupLoading").html('<span style="color:#FF0000">选择数据库失败。尝试创建数据库未成功。可能是权限不够，请先手动创建数据库</span>');
					break
...
<div class="main">
<div id="top-title">
<p><span class="title">Y-cityCMS v2.2.0</span><span> 安装程序</span></p>
</div>
EOF;

$footer = <<<EOF
<div>
<p class="foot">Powered by <a href="http://www.y-city.net.cn">Y-city</a></p></div>
</body>
</html>
EOF;
...
<div class="b">
    <p class="title2">1、Y-cityCMS许可协议</p>
    <div id="agreement">
    
    <p>版权所有 &copy; 2008-2012，新城网络保留所有权利。 </p>
				<p>感谢您选择新城网络企业网站内容管理系统（以下简称Y-cityCMS），Y-cityCMS是一款优秀的企业网站建设解决方案，基于PHP + MySQL技术开发。</p>
                <p>当您看到本协议时，则表明您的计算机（服务器）上已经存有Y-cityCMS，若您未取得合法的授权，请立即离开本页面，并删除Y-cityCMS。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
		    <p><strong>一、本授权协议适用于 Y-cityCMS 2.x 版本，天津启阳新程科技有限公司（新城网络）拥有对本授权协议的最终解释权。</strong>
      </p>
		    <p><strong>二、协议许可的权利 </strong>
      </p>
				<p>1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 </p>
				<p>2、您可以在协议规定的约束和限制范围内修改 Y-cityCMS 源代码或界面风格以适应您的网站要求。 </p>
				<p>3、您拥有使用本软件构建的网站全部内容所有权，并独立承担与这些内容相关的法律义务。 </p>
				<p>4、获得授权之后，您可以将本软件应用于商业用途，同时依据双方协议中确定的技术支持内容，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。</p>
			<strong>三、协议规定的约束和限制 </strong>
				<p>1、未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目的或实现盈利的网站）。请登陆   <a href="http://www.y-city.net.cn" target="_blank">www.y-city.net.cn</a> 了解最新说明。</p>
				<p>2、未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</p>
				<p>3、除非有特殊约定，否则无论网站是否整体使用 Y-cityCMS ，还是部份栏目使用 Y-cityCMS，在使用了 Y-cityCMS 的网站主页上必须加上 新城网络 官方网址(<a href="http://www.y-city.net.cn" target="_blank">www.y-city.net.cn</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 Y-cityCMS 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
				<p>5、如果您未能遵守本协议的条款，您的授权将被终止，所被许可的权利将被收回，并可能承担相应法律责任。 </p>
			<strong>四、有限担保和免责声明 </strong>
				<p>1、本软件及所附带的文件是作为不提供任何明确的或隐含的赔偿或担保的形式提供的。 </p>
				<p>2、用户出于自愿而使用本软件，您必须了解使用本软件的风险，在尚未购买产品技术服务之前，我们不承诺对用户提供任何形式的技术支持、使用担保，也不承担任何因使用本软件而产生问题的相关责任。 </p>
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装   Y-cityCMS，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
				<p>4、如果本软件带有其它软件的整合API示范例子包，这些文件版权不属于本软件官方，并且这些文件是没经过授权发布的，请参考相关软件的使用许可合法的使用。</p>
				<p><b>协议发布时间：</b> 2010年9月1日</p>
				<p><b>版本最新更新：</b> 2012年3月26日</p>
...
if($step == 2){
    ...
    $folder = array('.',
    '../../YcityCms/Runtime/Data',
    '../../YcityCms/Runtime/Cache',
    '../../YcityCms/Runtime/Logs',
    '../../YcityCms/Runtime/Temp',
    '../../Uploads',
	'../../Data'
    );
    $write = true;
...
<tr>
  <td>./YcityCms/Lib/Action</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr>
  <td>./YcityCms/Lib/Model</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
</tr>
</table>
...
<li>
    数据库名称：
      ...
      <input name="dbName" type="text" class="input" value="ycitycms" id="dbName">
</li>
<li>
    数据库前缀：
  <span class="care"> (同一个数据库安装多个Y-cityCMS系统，需要更换成其它名称，由英文字母、数字、下划线组成，且必须以下划线结束)</span><br />
  <input name="tablepre" type="text" class="input" id="tablepre" value="ycity_" readonly="readonly">
</li>
</div>
<div class="c">
...
<li>
网站名称：<br />
<input name="siteName" type="text" class="input" value="Y-cityCMS" id="siteName">
</li>
<li>
网　　址：<br />
...
<li>
公司名称：<br />
<input name="companyName" type="text" class="input" id="companyName" value="新城网络">
</li>
<li>
邮　　箱：<br />
<input name="email" type="text" class="input" id="email" value="admin@admin.com">
</li>
<li>
备 案 号：<br />
...
echo $footer;
    ...
    $tablepre = empty($tablepre) ? 'ycity_' : $tablepre ;
    ...
    $sqlFile = file_get_contents(CMS_ROOT.'/data.sql');
	...
	*/
    ...
    $query = "INSERT INTO `{$tablepre}user` (`role_id`, `username`, `password`, `realname`, `sex`, `telephone`, `mobile_telephone`, `fax`, `web_url`, `email`, `qq`, `address`, `login_count`, `create_time`, `update_time`, `last_login_time`) VALUES( 1, '$adminUsername', '$adminPasswordMd5', 'admin', '男', '05560000000', '13900000000', '05560000000', 'http://www.y-city.net.cn', 'y_city@qeeyang.com', '5565907', '', 1, $time, $time, $time)";
    mysql_query($query);
...
('$siteName', '$companyName', '$webUrl', 'Y-city', '15100000000', '$email', '15100000000', '15100000000', 'address a', '$icp', '5565907', 'y_city@qeeyang.com', 'Y-city', 0, '系统维护中.....', '', '', 1, 1, 'index,delete,modify,insert,update,login', 'Windows,Linux,Apple,其它', 'linux,windows', 1, 1, '100x100', 0, 5, 70, 2048000, 'gif,jpg,png,jpeg,swf,zip,rar,chm,7z,pdf', 1, '300,200', 1, '300,250', 1, '300,200', '300,200', 'seo_title', 'seo_keywords', 'Y-cityCMS,专业企业网站建设方案', $time, $time);";
     ...
     * 写入系统配置信息
     */
    $sampleConfig = file_get_contents(CMS_ROOT.'/config.sample.inc.php');
...
function splitsql($sql, $tablepre) {
    if($tablepre != "ycity_") $sql = str_replace("ycity_", $tablepre, $sql);
    $sql = str_replace("\r", "\n", $sql);
    $ret = array();
    $num = 0;
