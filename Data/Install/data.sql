...
CREATE TABLE `ycity_ad` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='广告' AUTO_INCREMENT=4 ;
...
CREATE TABLE `ycity_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='管理员操作日志' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='全局分类' AUTO_INCREMENT=1 ;
...
CREATE TABLE `ycity_link` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='链接' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `ycity_link`
--

INSERT INTO `ycity_link` (`id`, `title`, `title_style`, `title_style_serialize`, `category_id`, `link_type`, `link_url`, `description`, `attach_image`, `status`, `display_order`, `create_time`, `update_time`) VALUES
(1, '新城网络', 'color:#ff0000;font-weight:bold', 'a:2:{s:5:"color";s:7:"#ff0000";s:4:"bold";s:4:"bold";}', 1, 'text', 'http://www.y-city.net.cn', '', '', 0, 0, 1266392534, 0),
(2, '天津IDC', 'font-weight:bold', 'a:1:{s:4:"bold";s:4:"bold";}', 36, 'text', 'http://www.idctj.com', '', '', 0, 0, 1266392534, 1319440723);
...
CREATE TABLE `ycity_menu` (
  ...
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='导航' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `ycity_menu`
--

INSERT INTO `ycity_menu` (`id`, `title`, `title_style`, `title_style_serialize`, `parent_id`, `link_url`, `target`, `display_order`, `status`, `create_time`, `update_time`) VALUES
(1, '新城网络', '', '', 0, 'http://www.y-city.net.cn', '_blank', 0, 0, 1267540911, 1267541659);
...
--
-- 转存表中的数据 `ycity_module`
--

INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(4, '导航管理', 'Menu', '浏览=Menu_index|录入=Menu_insert|编辑=Menu_modify|批量操作=Menu_command', 1, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(7, '类别管理', 'Category', '浏览=Category_index|编辑=Category_modify|批量操作=Category_update', 1, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(8, '新闻管理', 'News', '浏览=News_index|编辑=News_modify|录入=News_insert|移动栏目=News_move|批量操作=News_command', 1, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(9, '产品管理', 'Product', '浏览=Product_index|录入=Product_insert|编辑=Product_modify|批量操作=Product_command|订单管理=Product_order|移动类别=Product_move', 0, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(10, '下载管理', 'Download', '浏览=Download_index|录入=Download_insert|编辑=Download_modify|批量操作=Download_command|移动栏目=Download_move', 0, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(11, '留言管理', 'Feedback', '浏览=Feedback_index|录入=Feedback_insert|编辑=Feedback_modify|批量操作=Feedback_command', 0, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(12, '招聘管理', 'Job', '浏览=Job_index|录入=Job_insert|编辑=Job_modify|应聘管理=Job_resume|批量操作=Job_command', 0, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(13, '公告管理', 'Notice', '浏览=Notice_index|录入=Notice_insert|编辑=Notice_modify|批量操作=Notice_command', 0, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(14, '链接管理', 'Link', '浏览=Link_index|录入=Link_insert|编辑=Link_modify|批量操作=Link_command', 0, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(15, '单页管理', 'Page', '浏览=Page_index|录入=Page_insert|编辑=Page_modify|批量操作=Page_command', 1, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(16, '广告管理', 'Ad', '浏览=Ad_index|录入=Ad_insert|编辑=Ad_modify|批量操作=Ad_command', 0, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(27, 'Tags', 'Tags', '管理=Tags', 1, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(28, '评论管理', 'Comment', '浏览=Comment_index|回复=Comment_modify|批量操作=Comment_command', 0, 1, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(29, '管理员管理', 'Admin', '浏览=Admin_index|录入=Admin_insert|编辑=Admin_modify|批量操作=Admin_command', 1, 0, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(31, '模板风格', 'Theme', '管理=Theme', 1, 0, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(30, '角色管理', 'AdminRole', '浏览=AdminRole_index|录入=AdminRole_insert|编辑=AdminRole_modify|批量操作=AdminRole_command', 1, 0, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(32, '模块管理', 'Module', '浏览=Module_index|编辑=Module_modify|安装=Module_install|卸载=Module_uninstall', 1, 0, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(33, '系统配置', 'Config', '浏览系统配置=Config_index|编辑系统配置=Config_modify|浏览核心配置=Config_core|编辑核心配置=Config_coreModify', 1, 0, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(34, '数据库管理', 'Database', '浏览=Database_index|执行SQL=Database_query|备份数据库=Database_export|恢复数据库=Database_import', 1, 0, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(35, '操作日志管理', 'AdminLog', '管理=AdminLog', 1, 0, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(36, '工具箱管理', 'Tools', '管理=Tools', 1, 0, '', '2.0', 0, 0, 0, 0);
INSERT INTO `ycity_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(37, '数据调用', 'Label', '管理=Label', 1, 0, '', '', 0, 0, 0, 0);
...
CREATE TABLE `ycity_order` (
  ...
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='订单' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ycity_role` (
...
INSERT INTO `ycity_role` (`id`, `role_name`, `role_permission`, `system`, `create_time`, `update_time`) VALUES
(1, '超级管理', 'Menu_index,Menu_insert,Menu_modify,Menu_command,Category_index,Category_modify,Category_update,News_index,News_modify,News_insert,News_move,News_command,Product_index,Product_insert,Product_modify,Product_command,Product_order,Product_move,Download_index,Download_insert,Download_modify,Download_command,Download_move,Feedback_index,Feedback_insert,Feedback_modify,Feedback_command,Job_index,Job_insert,Job_modify,Job_resume,Job_command,Notice_index,Notice_insert,Notice_modify,Notice_command,Link_index,Link_insert,Link_modify,Link_command,Page_index,Page_insert,Page_modify,Page_command,Ad_index,Ad_insert,Ad_modify,Ad_command,Tags,Comment_index,Comment_modify,Comment_command,Admin_index,Admin_insert,Admin_modify,Admin_command,Template,AdminRole_index,AdminRole_insert,AdminRole_modify,AdminRole_command', 1, 0, 0),
(2, '禁止访问', 'disable', 1, 0, 0),
(3, '普通管理', 'Menu_index,Menu_insert,Menu_modify,Menu_command,Category_index,Category_modify,News_index,News_modify,News_insert,News_move,News_command,Product_index,Product_insert,Product_modify,Product_command,Product_order,Product_move,Download_index,Download_insert,Download_modify,Download_command,Download_move,Feedback_index,Feedback_insert,Feedback_modify,Feedback_command,Job_index,Job_insert,Job_modify,Job_resume,Job_command,Notice_index,Notice_insert,Notice_modify,Notice_command,Link_index,Link_insert,Link_modify,Link_command,Page_index,Page_insert,Page_modify,Page_command,Ad_index,Ad_insert,Ad_modify,Ad_command,Tags,Comment_index,Comment_modify,Comment_command,Admin_index,Admin_insert,Admin_modify,Admin_command,Theme,AdminRole_index,AdminRole_insert,AdminRole_modify,AdminRole_command,Module_index,Module_install,Config_index,Config_core,Database_index,Database_export,AdminLog,Tools,Label,Product_index,Product_insert,Product_modify,Product_command,Product_move', 1, 0, 1317994448);
...
CREATE TABLE IF NOT EXISTS `ycity_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
